...
func TestSliceInt32(t *testing.T) {
	codec := lexy.MakeSliceOf[[]int32](int32Codec)
...
func TestSliceString(t *testing.T) {
	codec := lexy.MakeSliceOf[[]string](aStringCodec)
...
func TestSlicePtrUint8(t *testing.T) {
	p := ptr[uint8]
	pointerCodec := lexy.MakePointerTo[*uint8](uint8Codec)
	codec := lexy.MakeSliceOf[[]*uint8](pointerCodec)
...
func TestSlicePtrString(t *testing.T) {
	...
	codec := lexy.MakeSliceOf[[]*string](pointerCodec)
	testCodec(t, codec, []testCase[[]*string]{
		{"nil", nil, []byte{pNilFirst}},
		{"empty", []*string{}, []byte{pNonNil}},
...
func TestSliceSliceInt32(t *testing.T) {
	...
	codec := lexy.MakeSliceOf[[][]int32](sliceCodec)
	testCodec(t, codec, []testCase[[][]int32]{
		{"nil", nil, []byte{pNilFirst}},
		{"[]", [][]int32{}, []byte{pNonNil}},
...
func TestSliceSliceString(t *testing.T) {
	sliceCodec := lexy.MakeSliceOf[[]string](aStringCodec)
	codec := lexy.MakeSliceOf[[][]string](sliceCodec)
...
func TestSliceUnderlyingType(t *testing.T) {
	codec := lexy.MakeSliceOf[sInt](int32Codec)
...
func TestSliceNilsLast(t *testing.T) {
	encodeFirst := encoderFor(lexy.MakeSliceOf[[]int32](int32Codec))
	encodeLast := encoderFor(lexy.MakeSliceOfNilsLast[[]int32](int32Codec))
