...
func TestMapInt(t *testing.T) {
	testBasicMap(t, lexy.MapCodec[map[string]int32](aStringCodec, int32Codec, true))
}

type mStringInt map[string]int32

func TestMapUnderlyingType(t *testing.T) {
	testBasicMap(t, lexy.MapCodec[mStringInt](aStringCodec, int32Codec, true))
}

func TestMapSlice(t *testing.T) {
	codec := lexy.MapCodec[map[string][]string](aStringCodec, sliceCodec, true)
...
func TestMapPointerPointer(t *testing.T) {
	...
	codec := lexy.MapCodec[map[*string]*string](pointerCodec, pointerCodec, true)
...
func TestMapNilsLast(t *testing.T) {
	...
	encodeFirst := encoderFor(lexy.MapCodec[map[string]int32](aStringCodec, int32Codec, true))
	encodeLast := encoderFor(lexy.MapCodec[map[string]int32](aStringCodec, int32Codec, false))
