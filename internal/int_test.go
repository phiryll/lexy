...
func TestBoolCodec(t *testing.T) {
	testCodec[bool](t, internal.UintCodec[bool]{}, []testCase[bool]{
		{"false", false, []byte{0}},
		{"true", true, []byte{1}},
	})
}
...
func TestUint8Codec(t *testing.T) {
	testCodec[uint8](t, internal.UintCodec[uint8]{}, []testCase[uint8]{
		{"0x00", 0x00, []byte{0x00}},
		{"0x01", 0x01, []byte{0x01}},
		{"0x7F", 0x7F, []byte{0x7F}},
		{"0x80", 0x80, []byte{0x80}},
...
func TestUint32Codec(t *testing.T) {
	testCodec[uint32](t, internal.UintCodec[uint32]{}, []testCase[uint32]{
...
func TestInt8Codec(t *testing.T) {
	testCodec[int8](t, internal.IntCodec[int8]{Mask: math.MinInt8}, []testCase[int8]{
...
func TestInt32Codec(t *testing.T) {
	testCodec[int32](t, internal.IntCodec[int32]{Mask: math.MinInt32}, []testCase[int32]{
